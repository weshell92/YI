...
public class AdminContentController {
    ...
    public ApiResponse<?> updateCourse(@PathVariable Long id, @RequestBody CourseLesson courseLesson) {
        return ApiResponse.ok(contentService.saveCourse(new CourseLesson(
                ...
                courseLesson.stage(),
                courseLesson.title(),
                courseLesson.overview(),
                courseLesson.coreConcept(),
                courseLesson.plainExplanation(),
                courseLesson.termNotes(),
                courseLesson.bodyParagraphs(),
                courseLesson.diagram(),
                courseLesson.example(),
                courseLesson.realWorldAnalogy(),
                courseLesson.commonMistakes(),
                courseLesson.followUpLinks(),
                courseLesson.relatedTrigramIds(),
                courseLesson.relatedHexagramIds(),
